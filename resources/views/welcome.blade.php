...
<body class="antialiased">
    {{-- <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0"></div> --}}
    <div class="mb-3 bg-success">
        <img src="{{ asset('assets\images\mister.png') }}" id="imagenlogo" style="border-right: solid 2px darkgreen;">
        <span style="margin: 0 auto;">MISTER</span>
    </div>
    <div class="container">
